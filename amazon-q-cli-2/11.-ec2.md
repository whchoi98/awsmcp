...
랩을 시작하기 전에 다음 사항을 반드시 준비해야 합니다:

1. &#x20;AWS CLI가 설치 및 구성되어 있어야 합니다
2. Amazon Q CLI가 설치되어 있어야 합니다
3. 본 랩에서 사용하는 리소스를 생성하고 관리할 수 있는 AWS 권한이 있어야 합니다
...
앞서 생성한 context를 ec2ops 프로파일에 연결 구성합니다.
...
🌍 /home/ec2-user/.aws/amazonq/rules/AmazonQ.md (~710 tkns)
👤 /home/ec2-user/.aws/amazonq/rules/ec2ops.md (~1750 tkns)
...
<pre><code>ec2 리스트를 steampipe를 기반으로 조회해서, 표로 가시성 높게 제공해줘.
<strong>정리된 결과를 "~/tmp" 디렉토리에 마크다운으로 저장해줘.
</strong></code></pre>
...
CloudWatch에 새롭게 대시보드가 생성되었는지 확인해 봅니다.

<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption></figcaption></figure>

#### ✅  CloudWatch 알람 구성

CPU 20%가 초과하는 EC2들에 대한 알람을 설정해 봅니다.
...
#### Q CLI 채팅 창을 새롭게 오픈합니다.

💬 프롬프트 예시: 새로운 Q CLI 채팅창에서 자연어 입력
