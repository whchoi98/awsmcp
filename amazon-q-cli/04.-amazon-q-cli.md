...
```
> Review the code and update the code to address warnings from the test, specifically "LegacyAPIWarning: The Query.get() method ..."
```
...
필요하시면 위 작업을 GitBook 문서 스타일로 정리해드릴 수도 있습니다.
