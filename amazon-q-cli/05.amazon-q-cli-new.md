...
#### &#x20;“MCP Server는 항상 원격 서버인가?”&#x20;

#### 아니요. 대부분의 MCP Server는 로컬 프로세스(local process)로 실행됩니다.
...
#### Amazon Q CLI에서 Tool에 대한 세분화된 권한 설정 (Configuring Fine-Grained Permissions for Your Tools)&#x20;
...
#### 프로젝트 범위(Custom Scope)의 커스텀 에이전트 생성하기
