---
description: 'Update : 2025.09.22 / 10min'
---
...
Amazon Q Developer CLI는 Builder ID 또는 IAM Identity Center 계정으로 로그인하여 AI 기반 개발 도구를 사용할 수 있는 CLI 도구입니다. 이 가이드는 Linux 환경 (Amazon Linux 2023)에서 Q CLI를 설치하고 , 로그인하며, 환경 설정을 완료하는 기본 단계를 진행합니다.

***

### &#x20;<a href="#id-1.-glibc" id="id-1.-glibc"></a>
